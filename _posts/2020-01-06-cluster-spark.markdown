...
- 앞서 우리는 스파크가 지원하는 다양한 응용 프로그램들을 소개한 바 있다. 
    - 머신러닝(예측 분석)
    - SQL 쿼리, 시각화
    - 텍스트 마이닝
    - 추천엔진, 패턴인식 등

- 스파크를 실행하는 응용 프로그램은 모두 구성 요소가 있다. 
    - 드라이버 driver
    - 마스터 master
...
- 작업 요약
    1. 클라이언트가 스파크 응용프로그램을 드라이버에 제출함.
    2. 스파크 응용프로그램은 계획, 스케줄링, 실행, 모니터링을 함. 

- 모든 스파크 구성요소들은 자바 가상머신에서 실행된다. 
